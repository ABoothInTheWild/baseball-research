...
def MLBWinProbability(homeTeamAbbr, awayTeamAbbr, standingsOnDate, lastYearStandingsOnDate, override=False, inpDate = datetime(2019, 7, 11), homeAdditionalHomeWins=0, homeAdditionalHomeLosses=0, homeAdditionalTotalWins=0, homeAdditionalTotalLosses=0, awayAdditionalAwayWins=0, awayAdditionalAwayLosses=0, awayAdditionalTotalWins=0, awayAdditionalTotalLosses=0):
    ...
    #get posteriors
    homePostA = beta19Pre[beta19Pre.Team_Abbr == homeTeamAbbr1]["PriorAlpha"].values[0] + homeTeamTotalWins
    homePostB = beta19Pre[beta19Pre.Team_Abbr == homeTeamAbbr1]["PriorBeta"].values[0] + homeTeamTotalLosses
    awayPostA = beta19Pre[beta19Pre.Team_Abbr == awayTeamAbbr1]["PriorAlpha"].values[0] + awayTeamTotalWins
    awayPostB = beta19Pre[beta19Pre.Team_Abbr == awayTeamAbbr1]["PriorBeta"].values[0] + awayTeamTotalLosses
    minHomeGames = np.round((beta19Pre[beta19Pre.Team_Abbr == homeTeamAbbr1]["PriorAlpha"].values[0] + beta19Pre[beta19Pre.Team_Abbr == homeTeamAbbr1]["PriorBeta"].values[0])/2, 0)
    minAwayGames = np.round((beta19Pre[beta19Pre.Team_Abbr == awayTeamAbbr1]["PriorAlpha"].values[0] + beta19Pre[beta19Pre.Team_Abbr == awayTeamAbbr1]["PriorBeta"].values[0])/2, 0)
    ...
    #Get 2018 stats if not played enough in 2019
