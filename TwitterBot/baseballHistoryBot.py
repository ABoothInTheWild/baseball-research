...
def main(): 
    ...
    #define data
    master = pd.read_csv(r"C:\Users\Alexander\Documents\baseball\baseballdatabank-2017.1\baseballdatabank-2017.1\core\Master.csv")
    batting = pd.read_csv(r"C:\Users\Alexander\Documents\baseball\baseballdatabank-2017.1\baseballdatabank-2017.1\core\Batting.csv")
    batting = batting.dropna(subset=["SO"]).fillna(0)
    pitching = pd.read_csv(r"C:\Users\Alexander\Documents\baseball\baseballdatabank-2017.1\baseballdatabank-2017.1\core\Pitching.csv")
    teams = pd.read_csv(r"C:\Users\Alexander\Documents\baseball\baseballdatabank-2017.1\baseballdatabank-2017.1\core\Teams.csv")
