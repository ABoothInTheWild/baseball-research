...
#Set Directory
os.chdir(r"C:\Users\Alexander\Documents\Northwestern\Summer 2017\457\Assignment 2")

# read in conjoint survey profiles with respondent ranks
conjoint_data_frame = pd.read_csv('texans_seating_ranking.csv')
...
conjoint_attributes = ['price', 'seating', 'month', 'team']
...
effect_name_dict = {'price' : 'Ticket Price', \
    'seating' : 'Seating Area','month' : 'Month of Game', \
    'team' : 'Team Against'}  
